...
Section
  ...
  ;Links smartcash: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\smartcash" "" "URL:smartcash Protocol"
  WriteRegStr HKCU "Software\Classes\smartcash" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\smartcash" "DefaultIcon" "$\"$INSTDIR\electrum-smart.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\smartcash\shell\open\command" "" "$\"$INSTDIR\electrum-smart-${PRODUCT_VERSION}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\smartcash"
