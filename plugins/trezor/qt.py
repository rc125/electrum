...
from electrum_smart_gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
...
from .trezor import (TrezorPlugin, TIM_NEW, TIM_RECOVER, TrezorInitSettings,
                     RECOVERY_TYPE_SCRAMBLED_WORDS, RECOVERY_TYPE_MATRIX, PASSPHRASE_ON_DEVICE)
